...
//////////////////////////Poison stuff///////////////////////
		...
		toxin/clownmutagen
			...
			id = "clownmutagen"
			color = "#13BC5E"
			on_mob_life(var/mob/living/carbon/human/H as mob)
				if(!H) H = holder.my_atom
				var/chance = rand(0,100)
				if(chance < 50)
					H.activate_mutation("clownface")
				else
					H.activate_mutation("clownstep")
				..()
				return

		toxin/shellfishmutagen
		...
		toxin/activemutagen
			...
			on_mob_life(var/mob/living/carbon/human/H as mob)
				...
				var/chance = rand(0,100)
				if(chance < 25)
					H.activate_mutation("thermal")
				else if(chance < 50)
					H.activate_mutation("invisible")
				else
					H.activate_mutation("onfire")
				..()
				return
		...
		toxin/monkeymutagen
			...
			on_mob_life(var/mob/living/carbon/human/H as mob)
				...
				var/chance = rand(0,100)
				if(chance < 50)
					H.activate_mutation("monkeyhead")
				else
					H.activate_mutation("htm")
				..()
				return
		...
		toxin/crabmutagen
			...
			on_mob_life(var/mob/living/carbon/human/H as mob)
				...
				var/chance = rand(0,100)
				if(chance < 50)
					H.activate_mutation("crab_direction")
				else
					return
				..()
				return
		...
		toxin/mindmutagen
			...
			on_mob_life(var/mob/living/carbon/human/H as mob)
				...
				var/chance = rand(0,100)
				if(chance < 50)
					H.activate_mutation("ohmybrain")
				else
					H.activate_mutation("silence")
				..()
				return
		...
		toxin/metalmutagen
			...
			on_mob_life(var/mob/living/carbon/human/H as mob)
				...
				var/chance = rand(0,100)
				if(chance < 50)
					H.activate_mutation("human_to_robot")
				else
					H.activate_mutation("metal")
				..()
				return
