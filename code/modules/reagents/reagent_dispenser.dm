...
/obj/structure/reagent_dispensers/nitrogen
	name = "nitrogen keg"
	desc = "A nitrogen keg"
	icon = 'icons/obj/objects.dmi'
	icon_state = "beertankTEMP"
...
/obj/structure/reagent_dispensers/hydrogen
	name = "hydrogen keg"
	desc = "A hydrogen keg"
	icon = 'icons/obj/objects.dmi'
	icon_state = "beertankTEMP"
...
/obj/structure/reagent_dispensers/sulfur
	name = "sulfur keg"
	desc = "A sulfur keg"
	icon = 'icons/obj/objects.dmi'
	icon_state = "beertankTEMP"
...
/obj/structure/reagent_dispensers/potassium
	name = "potassium keg"
	desc = "A potassium keg"
	icon = 'icons/obj/objects.dmi'
	icon_state = "beertankTEMP"
	amount_per_transfer_from_this = 10
	New()
...
/obj/structure/reagent_dispensers/ethanoltank
	...
	New()
		..()
		reagents.add_reagent("ethanol",200)
