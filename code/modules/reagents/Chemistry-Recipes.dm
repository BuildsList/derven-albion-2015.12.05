...
/datum/chemical_reaction/monkeymutagen
	name = "Monkey mutagen"
	id = "monkeymutagen"
	result = "monkeymutagen"
	required_reagents = list("mutagen" = 1, "bananium" = 1, "uranium" = 1)
	result_amount = 2

/datum/chemical_reaction/clownmutagen
	name = "Clown mutagen"
	id = "clownmutagen"
	result = "clownmutagen"
	required_reagents = list("mutagen" = 1, "bananium" = 1)
	result_amount = 2

/datum/chemical_reaction/shellfishmutagen
	name = "Shellfish mutagen"
	id = "shellfishmutagen"
	result = "shellfishmutagen"
	required_reagents = list("mutagen" = 1, "lube" = 1)
	result_amount = 2

/datum/chemical_reaction/activemutagen
	name = "Active mutagen"
	id = "activemutagen"
	result = "activemutagen"
	required_reagents = list("mutagen" = 1, "uranium" = 1)
	result_amount = 2

/datum/chemical_reaction/plantmutagen
	name = "Plant mutagen"
	id = "plantmutagen"
	result = "plantmutagen"
	required_reagents = list("mutagen" = 1, "chlorofill" = 1)
	result_amount = 2

/datum/chemical_reaction/crabmutagen
	name = "Crab mutagen"
	id = "crabmutagen"
	result = "crabmutagen"
	required_reagents = list("mutagen" = 1, "crabin" = 1)
	result_amount = 2

/datum/chemical_reaction/psimutagen
	name = "Psi mutagen"
	id = "psimutagen"
	result = "psimutagen"
	required_reagents = list("mutagen" = 1, "spacedrugs" = 1)
	result_amount = 2

/datum/chemical_reaction/nothingmutagen
	name = "Nothing mutagen"
	id = "nothingmutagen"
	result = "activemutagen"
	required_reagents = list("mutagen" = 1, "nothing" = 1)
	result_amount = 2

/datum/chemical_reaction/elfmutagen
	name = "Elf mutagen"
	id = "elfmutagen"
	result = "elfmutagen"
	required_reagents = list("mutagen" = 1, "elfin" = 1)
	result_amount = 2

/datum/chemical_reaction/dragonmutagen
	name = "Dragon mutagen"
	id = "dragonmutagen"
	result = "dragonmutagen"
	required_reagents = list("mutagen" = 1, "fuel" = 1)
	result_amount = 2

/datum/chemical_reaction/mindmutagen
	name = "Mind mutagen"
	id = "mindmutagen"
	result = "mindmutagen"
	required_reagents = list("mutagen" = 1, "carbon" = 1)
	result_amount = 2

/datum/chemical_reaction/metalmutagen
	name = "Metal mutagen"
	id = "metalmutagen"
	result = "metalmutagen"
	required_reagents = list("mutagen" = 1, "iron" = 1)
	result_amount = 2

/datum/chemical_reaction/goldmutagen
	name = "Gold mutagen"
	id = "goldmutagen"
	result = "goldmutagen"
	required_reagents = list("mutagen" = 1, "gold" = 1)
	result_amount = 2
...
/datum/chemical_reaction/asaltpeter
	name = "Asaltpeter"
	id = "asaltpeter"
	result = "asaltpeter"
	required_reagents = list("hydrogen" = 1, "nitrogen" = 2)
	result_amount = 2

/datum/chemical_reaction/posaltpeter
	name = "posaltpeter"
	id = "posaltpeter"
	result = "posaltpeter"
	required_reagents = list("hydrogen" = 1, "nitrogen" = 2, "potassium" = 3)
	result_amount = 2

/datum/chemical_reaction/ultra_gunpowder
	name = "Ultra Gunpowder"
	id = "ultragunpowder"
	result = "ultragunpowder"
	required_reagents = list("asaltpeter" = 1, "sulfur" = 1, "ethanol" = 1)
	result_amount = 2

/datum/chemical_reaction/super_gunpowder
	name = "Super Gunpowder"
	id = "supergunpowder"
	result = "gunpowder"
	required_reagents = list("posaltpeter" = 1, "sulfur" = 1)
	result_amount = 2

/datum/chemical_reaction/classic_gunpowder
	name = "Gunpowder"
	id = "gunpowder"
	result = "gunpowder"
	required_reagents = list("asaltpeter" = 1, "sulfur" = 1)
	result_amount = 2

/datum/chemical_reaction/super_gunpowder/on_reaction(var/datum/reagents/holder, var/created_volume)
	var/location = get_turf(holder.my_atom)
	var/datum/effect/effect/system/reagents_explosion/e = new()
	e.set_up(round (created_volume, 1), location, 1, 2)
	e.start()

	holder.clear_reagents()
	return

/datum/chemical_reaction/ultra_gunpowder/on_reaction(var/datum/reagents/holder, var/created_volume)
	var/location = get_turf(holder.my_atom)
	var/datum/effect/effect/system/reagents_explosion/e = new()
	e.set_up(round (created_volume, 1), location, 5, 5)
	e.start()

	holder.clear_reagents()
	return

/datum/chemical_reaction/classic_gunpowder/on_reaction(var/datum/reagents/holder, var/created_volume)
	var/location = get_turf(holder.my_atom)
	var/datum/effect/effect/system/reagents_explosion/e = new()
