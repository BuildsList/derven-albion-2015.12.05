...
/obj/item/weapon/paper/PRISONERS_CODES
	name = "paper- 'PRISONERS_CODES'"

	New()
		for(var/i = 1, i <= names_bracelets.len, i++)
			info += names_bracelets[i]

/obj/item/weapon/paper/PRISONERS_CODES/attack_self(mob/user as mob)
	for(var/i = 1, i <= names_bracelets.len, i++)
		info += names_bracelets[i]
