/mob/living/carbon/human/examine()
	...
	if(broken_bone_head == 1)
		msg += "<br><span class='info'> Похоже у этого человека проломлен череп <br>"
	if(broken_bone_chest == 1)
		msg += "<br><span class='info'> Похоже у этого человека есть переломы в области туловища<br>"
	if(broken_bone_groin == 1)
		msg += "<br><span class='info'> Похоже у этого человека есть переломы в области таза<br>"
	if(broken_bone_r_leg == 1)
		msg += "<br><span class='info'> Похоже у этого человека есть переломы в области правой ноги<br>"
	if(broken_bone_l_leg == 1)
		msg += "<br><span class='info'> Похоже у этого человека есть переломы в области левой ноги<br>"
	if(broken_bone_l_arm == 1)
		msg += "<br><span class='info'> Похоже у этого человека есть переломы в области левой руки<br>"
	if(broken_bone_r_arm == 1)
		msg += "<br><span class='info'> Похоже у этого человека есть переломы в области правой руки<br>"

	if(src == usr)
		if(a_intent == "harm")
			msg += "<span class='info'><br>Этот человек подн&#255;л руки на уровни груди и готов напасть"
		if(a_intent == "disarm")
			msg += "<span class='info'><br>Этот человек напр&#255;жен"
		if(a_intent == "grab")
			msg += "<span class='info'><br>Этот человек осматриваетс&#255;"
