...
//		if(user != src)
	...
	if(I.attack_verb && I.attack_verb.len)
		...
		if(user.a_intent == "harm")
			...
			if(I.damage_types == "melee")
				if(chance < 6 || I.force > 15)
					broken_random_bone_into_location(hit_area)
//				if(chance < 6 || I.force > 15)
//					damage_random_organ_into_location(hit_area)
			if(I.damage_types == "sharp")
				if(chance < 35 || I.force > 15)
					damage_random_artery_into_location(hit_area)
//				if(chance < 6 || I.force > 15)
//					damage_random_organ_into_location(hit_area)
