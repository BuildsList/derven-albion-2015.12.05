...
//		alt_name = " (as [get_id_name("Unknown")])"
	...
	if (length(heard_a))
		...
		rendered = "<span class='game say'><span class='name'>[gender_word] [age_word]</span> [whispers], <span class='message'>\"[message_a]\"</span></span>"
	...
	if (length(heard_b))
		...
		rendered = "<span class='game say'><span class='name'>[gender_word] [age_word]</span> [whispers], <span class='message'>\"[message_b]\"</span></span>"
	...
	for (var/mob/M in eavesdropping)
		if (M.say_understands(src))
			...
			rendered = "<span class='game say'><span class='name'>[gender_word] [age_word]</span> [whispers], <span class='message'>\"[message_c]\"</span></span>"
			M.show_message(rendered, 2)
		else
			rendered = "<span class='game say'><span class='name'>[gender_word] [age_word]</span> [whispers] something.</span>"
			M.show_message(rendered, 2)

	if (italics)
		message = "<i>[message]</i>"
	rendered = "<span class='game say'><span class='name'>[gender_word] [age_word]</span> [whispers], <span class='message'>\"[message]\"</span></span>"
