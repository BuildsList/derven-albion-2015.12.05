...
/obj/machinery/power/port_gen/pacman
	...
	var/set_temperature = 500

/obj/machinery/power/port_gen/pacman/NUCLEAR
	name = "nuclear generator"
	icon = 'icons/obj/nuck_generator.dmi'
	sheets = 0
	max_sheets = 100
	sheet_name = ""
...
/obj/machinery/power/port_gen/pacman/New()
	..()
	if(istype(src, /obj/machinery/power/port_gen/pacman/diesel))
		//var/obj/machinery/power/port_gen/pacman/diesel/D = src
		create_reagents(1000)
		reagents.add_reagent("ethanol", 50)
		sleep(5)
		//D.use_reagent += "ethanol"
		//D.use_reagent += "cornoil"
		//D.use_reagent += "fuel"
...
/obj/machinery/power/port_gen/pacman/HasFuel()
	...
	else if(sheets >= 1 / (time_per_sheet / power_output) - sheet_left)
		return 1
	return 0
...
/obj/machinery/power/port_gen/pacman/UseFuel()
	...
	if (sheet_left <= 0 && sheets > 0)
		...
		sheets--
	if(istype(src, /obj/machinery/power/port_gen/pacman/NUCLEAR))
