...
/datum/job/captain/equip_items(var/mob/living/carbon/human/H)
	...
	H.equip_to_slot_or_del(new /obj/item/weapon/card/id/gold, slot_wear_id)
	H.equip_to_slot_or_del(new /obj/item/weapon/card/id/key(H), slot_l_hand)
	//Equip ID box & telebaton
	if(H.backbag == 1)
		H.equip_to_slot_or_del(new /obj/item/weapon/card/id/key(H), slot_l_hand)
	else
		H.equip_to_slot_or_del(new /obj/item/weapon/card/id/key(H.back), slot_in_backpack)
	...
	world << "<b>[H.real_name] - капитан полции!</b>"
