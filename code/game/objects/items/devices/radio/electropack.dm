var/global/codefrec
var/global/num_of_bracelet = 0
var/global/list/names_bracelets = list()
var/global/cur_brac = ""

/obj/item/device/radio/electropack/gloves
	slot_flags = SLOT_GLOVES
	name = "prison bracelets"
	desc = "BOOM"
	...
	New()
		...
		code = codefrec
		num_of_bracelet += 1
		name = "prison bracelets #[num_of_bracelet]"
		cur_brac = "prison bracelets #[num_of_bracelet]; code = codefrec"
		desc = "prison bracelets #[num_of_bracelet]; boomcode [code]"
		names_bracelets += cur_brac
...
/obj/item/device/radio/electropack/receive_signal(datum/signal/signal)
	...
	if(ismob(loc) && on)
		...
		if(istype(src, /obj/item/device/radio/electropack/gloves))
