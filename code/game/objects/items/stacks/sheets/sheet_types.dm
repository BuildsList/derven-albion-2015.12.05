...
var/global/list/datum/stack_recipe/wood_recipes = list ( \
	...
	new/datum/stack_recipe("bonfire", /obj/structure/wood_wood, 2, time = 5, one_per_turf = 1, on_floor = 1), \
	new/datum/stack_recipe("crate", /obj/structure/closet/crate/wooden, 4, time = 15, one_per_turf = 1, on_floor = 1), \
	new/datum/stack_recipe("spear", /obj/item/weapon/twohanded/spear/wooden, 2, time = 15, one_per_turf = 1, on_floor = 1), \
