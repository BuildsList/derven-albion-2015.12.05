/obj/item/weapon/reagent_containers/food/snacks/chocolatebar/sesinka
	name = "Sesinka choco!"

/obj/item/weapon/reagent_containers/food/snacks/muffin/berry/sesinka
	name = "Sesinka muffin!"

/obj/machinery/gibber/choco
	name = "choco_machine"
	desc = "Sesinka inc machine"
	icon = 'icons/obj/kitchen.dmi'
	icon_state = "grinder"
	density = 1
	anchored = 1
	operating = 0 //Is it on?
	dirty = 0 // Does it need cleaning?
	gibtime = 40 // Time from starting until meat appears
	use_power = 1
	idle_power_usage = 2
	active_power_usage = 500

/obj/machinery/gibber/muffin
	name = "muffin_machine"
	desc = "Sesinka inc machine"
	icon = 'icons/obj/kitchen.dmi'
	icon_state = "grinder"
...
/obj/machinery/gibber/proc/startgibbing(mob/user as mob)
	...
	if(istype(src, /obj/machinery/gibber/choco))
		new /obj/item/weapon/reagent_containers/food/snacks/chocolatebar/sesinka(src.loc)
		new /obj/item/weapon/reagent_containers/food/snacks/chocolatebar/sesinka(src.loc)
		new /obj/item/weapon/reagent_containers/food/snacks/chocolatebar/sesinka(src.loc)
		new /obj/item/weapon/reagent_containers/food/snacks/chocolatebar/sesinka(src.loc)
		new /obj/item/weapon/reagent_containers/food/snacks/chocolatebar/sesinka(src.loc)
		...
		new /obj/item/weapon/reagent_containers/food/snacks/chocolatebar/sesinka(src.loc)
		new /obj/item/weapon/reagent_containers/food/snacks/chocolatebar/sesinka(src.loc)
	else if(istype(src, /obj/machinery/gibber/muffin))
		new /obj/item/weapon/reagent_containers/food/snacks/muffin/berry/sesinka(src.loc)
		new /obj/item/weapon/reagent_containers/food/snacks/muffin/berry/sesinka(src.loc)
		new /obj/item/weapon/reagent_containers/food/snacks/muffin/berry/sesinka(src.loc)
		new /obj/item/weapon/reagent_containers/food/snacks/muffin/berry/sesinka(src.loc)
		new /obj/item/weapon/reagent_containers/food/snacks/muffin/berry/sesinka(src.loc)
